...
import { LoyaltyMechanicsResponse } from '@/types/loyalty';

interface LoyaltyMechanicsResultProps {
  results: LoyaltyMechanicsResponse;
}

const LoyaltyMechanicsResult: React.FC<LoyaltyMechanicsResultProps> = ({ results }) => {
